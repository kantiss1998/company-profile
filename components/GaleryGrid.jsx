    ...
    <div>
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
        {images.map((img, index) => (
          <div
            key={index}
            className={`relative overflow-hidden rounded-lg shadow-lg aspect-w-1 aspect-h-1 transform transition duration-500 hover:scale-105 hover:shadow-xl cursor-pointer ${
              img.span || ""
            }`}
