...
export const metadata: Metadata = {
  title: 'Galery',
  description:
    'Kami dengan bangga mempersembahkan berbagai inovasi dan teknologi terdepan yang kami tawarkan.',
}

export default function Gallery() {
  return (
    <>
      <PageIntro eyebrow="Galery" title="Teknologi dan Keandalan">
        <p>
          Kami dengan bangga mempersembahkan berbagai inovasi dan teknologi terdepan yang kami tawarkan. Setiap mesin yang kami tampilkan adalah hasil dari penelitian mendalam dan pengembangan berkelanjutan, dirancang untuk memenuhi kebutuhan industri dan memberikan solusi efisien bagi pelanggan kami.
        </p>
      </PageIntro>
